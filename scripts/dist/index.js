 ...
 */
function showActionHelp(moduleName, actionName) {
    const moduleDesc = MODULE_DESCRIPTIONS[moduleName] || '';
    const actionDescs = ACTION_DESCRIPTIONS[moduleName] || {};
 ...
 */
function groupActionsByCategory(actions, moduleName) {
 ...
 */
function detectModuleFromActions(actions) {
 ...
 */
function groupAssetDbActionsByCategory(actions) {
    const categories = {
        '状态': [],
        '资源操作': [],
        '资源编辑': [],
 ...
 */
function groupSceneActionsByCategory(actions) {
    const categories = {
        '生命周期操作': [],
        '节点操作': [],
        '组件操作': [],
